...
for (i in c(2:5)) {
  ...
  colnames(DeathCaseMat) <- c("Type","0 to 4","5 to 9","10 to 14","15 to 19","20 to 24","25 to 29","30 to 34","35 to 39","40 to 44","45 to 49","50 to 54","55 to 59","60 to 64","65 to 69","70 to 74","75+","Scenario")
...
write.csv(bigdata, file = "E:/Global Model/c.csv")
bigdata <- read.csv("E:/Global Model/c.csv")
...
DeathCaseLine <- ggplot(bigdata, aes(x = Generation, y = Number_of_deaths_reduced)) +
  geom_line(aes(fill=Number_of_deaths_reduced)) +
